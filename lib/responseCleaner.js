...
export function validateAndCleanResponse(response, minLength = 20) {
  ...
  // Be more lenient - allow slightly shorter responses if they're complete
  const effectiveMinLength = Math.max(10, minLength - 5); // Allow 5 chars below minimum if complete
