...
class PyqService {
  ...
  _processTheme(theme, fromYear, toYear, userMsg, language, levelHint = '') {
    ...
    theme = theme.replace(/\b(give|show|get|find|search|fetch|list|bring|tell|me|the|a|an|all|some|any|need|want|bring|can|could|would|please|kindly|i|my|more|other|another)\b/gi, '').trim();
