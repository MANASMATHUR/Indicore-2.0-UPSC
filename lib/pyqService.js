...
class PyqService {
  ...
  parseQuery(userMsg, language) {
    ...
    // Remove common polite phrases and connectors (including command verbs)
    let cleanMsg = userMsg.replace(/\b(can you|could you|would you|please|kindly|i need|i want|i'd like|solve|answer|explain)\b/gi, '');
