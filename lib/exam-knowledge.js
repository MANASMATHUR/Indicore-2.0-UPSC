class ExamKnowledge {
  ...
  initSubjectTopics() {
    return {
      ...
      csat: {
        weightage: 'Qualifying (33%) but critical for Prelims',
  ...
  detectSubjectFromQuery(query) {
    ...
    const subjectKeywords = {
      ...
      csat: ['profit', 'loss', 'cost price', 'sale price', 'selling price', 'percentage', 'ratio', 'proportion', 'interest', 'time and work', 'distance', 'speed', 'average', 'permutation', 'combination', 'probability', 'syllogism', 'blood relation', 'coding-decoding', 'seating arrangement', 'data interpretation', 'quantitative', 'aptitude', 'reasoning']
    };
