...
function AdminDashboardContent() {
  ...
  const exportToCSV = () => {
    ...
    a.href = url;
    a.download = `indicore-users-${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Indicore Admin Dashboard</h1>
          <p className="text-gray-600 mt-2">User Analytics & Data Management</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-medium text-gray-900">Avg Chats/User</h3>
            <p className="text-3xl font-bold text-purple-600">{stats.averageChatsPerUser}</p>
          </div>
        </div>
        ...
        <div className="mt-8 text-center text-gray-500">
          <p>Data generated at: {new Date().toLocaleString()}</p>
        </div>
      </div>
    </div>
  );
