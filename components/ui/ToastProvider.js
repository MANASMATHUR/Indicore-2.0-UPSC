    ...
    <ToastContext.Provider value={value}>
      ...
      <div className="fixed bottom-4 right-4 z-50 space-y-2 pointer-events-none max-w-sm">
        {toasts.map((t) => (
          <div
            key={t.id}
            className={`pointer-events-auto px-4 py-3 rounded-lg shadow-lg border backdrop-blur-sm animate-slide-in flex items-start gap-3 relative overflow-hidden ${getToastClasses(t.type)}`}
          >
            {/* Icon */}
